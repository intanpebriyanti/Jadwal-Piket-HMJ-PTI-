...
constructor(props) {
 ...
 InsertStudentRecordsToServer = () =>{
      ...
      fetch('http://nukeninkonoha.000webhostapp.com/api/InsertStudentData.php', {
      method: 'POST',
      headers: {
...
class ShowStudentListActivity extends Component {
  ...
  componentDidMount() {
       ...
       return fetch('http://nukeninkonoha.000webhostapp.com/api/Student/ShowAllStudentsList.php')
         .then((response) => response.json())
         .then((responseJson) => {
...
class EditStudentRecordActivity extends Component {
  ...
  constructor(props) {
    ...
    UpdateStudentRecord = () =>{
            ...
            fetch('http://nukeninkonoha.000webhostapp.com/api/Student/UpdateStudentRecord.php', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
    ...
    DeleteStudentRecord = () =>{
          ...
          fetch('http://nukeninkonoha.000webhostapp.com/api/DeleteStudentRecord.php', {
          method: 'POST',
          headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
